<template>
  <nav>
    ...
    <a href="#">
        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 496 512">
          <path
    ...
    <a href="#">
        <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
          <path
