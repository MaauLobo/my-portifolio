<template>
  <div>
    <nav>
      <div class="logo">
        <!-- Substitua o src pelo caminho da sua imagem/logo -->
        <h1>Mau</h1>
      </div>
      ...
      <div class="center-options">
        ...
        <a href="#"><font-awesome-icon icon="code" /> Tech Stack</a>
    ...
    <div class="me">
      <div class="text">
        <h1>Olá👋🏽,<br>Meu nome é<br><div class="name">Mauricio</div>Sou um Desenvolvedor Web</h1>
      </div>
      <div class="picture">
